% Francisco Olivera's "Double Maximum Method" flow direction upscaling algorithm
%
% Inputs
...
%
% Still need to write this. Currently, it is just copied over from FLOW.

function fd_coarse = double_maximum_method(fd_fine, facc_fine, f, R)
